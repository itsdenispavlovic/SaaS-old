        ...
        @foreach($nodes as $node)
            <tr id='row{{ $node->id }}'>
                ...
                <td>
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('admin.nodes.show', [$node->id]) }}" class='btn btn-ghost-success'><i class="fa fa-eye"></i></a>
                        <a href="{{ route('admin.nodes.edit', [$node->id]) }}" class='btn btn-ghost-info'><i class="fa fa-edit"></i></a>
